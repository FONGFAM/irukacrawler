...
from src.dashboard.components.tabXetDuyet import render_tab_xet_duyet
...
pg_danh_sach = st.Page(render_tab_danh_sach, title="Danh sách tài liệu", icon=":material/table:", url_path="danh_sach")
pg_xet_duyet = st.Page(render_tab_xet_duyet, title="Xét duyệt", icon=":material/fact_check:", url_path="xet_duyet")

pg = st.navigation([pg_thu_thap, pg_thong_ke, pg_danh_sach, pg_xet_duyet])
