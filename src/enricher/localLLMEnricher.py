...
- doc_type (chọn đúng 1): [{_DOC_TYPES_STR}, khac] 
  + Gợi ý: pl.* (Pháp lý/Thông tư); sgk.* (Sách giáo khoa/Tập tô cho trẻ); gt.giao_an (Giáo án của CÔ GIÁO); gt.truong (Giáo trình đại học/cao đẳng dạy về mầm non); bt.bo_tro (Bài tập/Phiếu bài tập cho TRẺ); bt.truyen_tho (Truyện/Thơ); kn.* (Sáng kiến kinh nghiệm/Mẹo dạy); nc.* (Nghiên cứu/Bài báo/Giáo trình dạy sinh viên/Tập huấn GV).
